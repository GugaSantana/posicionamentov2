...
<div class="card card-primary">
    ...
    <div class="card-body">
                ...
                <div class="col-12">
                    ...
                    <p class="fonte18">Para entender a Inteligência Emocional temos que partir do princípio que o cérebro está constituído por 2 Hemisférios.</p>
                    ...
                    {!! $diagnostico !!}
                        ...
                        <p class="fonte18"><b>Motivação:</b> relacionada à vontade e à paixão do indivíduo por suas atividades e trabalho, independente de recompensas financeiras ou de status social.</p>
                        ...
                        <p class="fonte18">Lembre-se das Recomendações dadas no Instrumento 7: coloque sua personalidade sob o controle de Estado do Ego Adulto.</p>
                        <br>
                        ...
                        <p class="fonte18">Empatia é entender o próximo, entender como alguém está se sentindo e por que se comporta de determinada maneira.</p>
                        ...
                        <p class="fonte18">Outro ponto chave para o sucesso é saber ter boas relações levando em consideração as emoções dos outros. Assim, você criará um ambiente positivo à sua volta.</p>
                        <p class="fonte18">As Recomendações do Instrumento 7 poderá ajudá-lo (a) a melhorar seu relacionamento interpessoal ajustando os seus Estados do Ego aos Estados do Ego do seu cliente.</p>
                        <br>
                        ...
                        <p class="fonte18">Lembre-se das Recomendações dadas no Instrumento 7. Utilize o Estado do Ego Adulto, coloque sua personalidade sob o comando do Adulto.</p>
                        <br>
                        ...
                        <p class="fonte18">Lembre-se que suas emoções influenciam suas decisões.</p>
                        <br>
                        <h4>9 - Conheça seus limites.</h4>
                        <p class="fonte18">Há momentos em que é importante definir nossos limites adequadamente. Estes limites podem incluir o exercício de discordar, de dizer "não" sem se sentir culpado e de controlar nossas respostas impulsivas para não ser vítima do curto prazo.</p>
                        ...
                        - Ter mais senso de responsabilidade e uma melhor visão de futuro.<br>
                        - Aumentar a autoestima e a autoconfiança.</p>
