...
<div class="card card-primary">
    ...
    <div class="card-body">
                ...
                <div class="col-12">
                    ...
                    <center><img src="../posicionamento/public/img/diag_13_1.jpg" style="width: 60%;"></center><br>
                    ...
                    <br>
                        ...
                        <center><img src="../posicionamento/public/img/diag_13_2.jpg" style="width: 40%;"></center>
                       <!--  <div class="row">
                            <div class="col-12" style="overflow: auto;">
                                <table class="tg table" style="border: none">
                                    <tr>
                                        <td rowspan="3" style="font-size: 18px; vertical-align: middle; text-align: center; width: 10px; border: none; padding: 0"><img src="../posicionamento/public/img/diag_13_2.jpg"></td>
                        ...
                        <center><img src="../posicionamento/public/img/diag_13_3.jpg" style="width: 50%;"></center><br>
