...
<div class="card card-primary">
    ...
    <div class="card-body">
                ...
                <div class="col-12">
                    ...
                    <p class="fonte18">Os resultados que você atribuiu a cada atividade do Relatório do Progresso conforme a escala abaixo apresentada, foram os seguintes:</p>                    
                    ...
                    <p class="fonte18">Isto significa que você tem um potencial de melhoria de <b>{{5 - (array_sum($retorno) / 5 )}}</b> pontos neste instrumento, ou seja, você pode melhorar em <b>{{(5 - (array_sum($retorno) / 5 )) * 100 / 5}}%</b> sua eficácia para realizar de maneira profissional o Relatório de Progresso</p>

                        <br>
                        <p class="fonte18"><h4><center>RECOMENDAÇÕES</center></h4></p>

                        <p class="fonte18">Você deve começar dedicando seu esforço na atividade na qual obteve o menor valor, a seguir a de segundo menor valor e assim sucessivamente.</p>
                        <p class="fonte18">Claro que você também pode melhorar mais de uma atividade simultaneamente.</p>
                        <p class="fonte18">As recomendações para melhorar seu desempenho nas 5 etapas do Relatório do Progresso são os seguintes:</p>
                        <br>
                        <p class="fonte18">1 – PLANEJADO</p>
                        <p class="fonte18">Esta atividade corresponde ao QUE (What), a primeira atividade do Instrumento 19 – Plano de Ação Quantitativo para alcançar as metas de venda.</p>
                        ...
                        <p class="fonte18">O objetivo ~e definir o que e quanto foi executado e assim mostrar se você está cumprindo o cronograma (When) do Plano de Ação.</p>
