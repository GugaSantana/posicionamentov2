...
<div class="card card-primary">
    ...
    <div class="card-body">
                ...
                <div class="col-12">
                    ...
                    <p class="fonte18">Segmentação é a seleção do público-alvo para desenvolver o trabalho, dentre todos os públicos que constituem o mercado e serve para dar Foco ao seu trabalho e facilitar o alcance de suas Metas de Faturamento.</p>
                    ...
                    <div class="row">
                        ...
                        <p class="fonte18">- Pesquise, veja como estão posicionados os clientes de seus colegas em relação a esses 11 fatores e analise o posicionamento de mercado de seus concorrentes.</p>
                        ...
                        <form name="formulario" role="form" method="post" action="/instrumento/11_2/pf">
                            {!! csrf_field() !!}
                            <div class="row">
                                <div class="col-12" style="overflow: auto;">
                                    <table class="table table-hover table-bordered">
