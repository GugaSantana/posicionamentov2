...
<div class="card card-primary">
    ...
    <div class="card-body">
                    ...
                    <center><img src="../posicionamento/public/img/instrumento16/diag_16_1_new.jpg" style="width: 60%;"></center><br>
...
<p class="fonte18">Implementando as recomendações deste instrumento e do instrumento anterior, você poderá gerenciar o <b>Campo de Forças das Vendas.</b></p>
                    ...
                    <p class="fonte18">No questionário de respostas deste instrumento você listou os obstáculos que aparecem com maior freqüência na etapa de NEGOCIAÇÃO das Vendas Consultivas.</p>
                    <p class="fonte18">As Forças Restritivas (obstáculos) mais freqüentes que você listou foram classificadas e colocadas na Matriz de Forças Restritivas (R’s), gerando o seguinte resultado:</p>
                    ...
                    <p class="fonte18">Refere-se a palavras ou atitudes inconvenientes do cliente que prejudicam o progresso da venda. Muitas vezes este obstáculo decorre de falhas na comunicação e a precária inteligência emocional do vendedor.</p>
                        ...
                        <p class="fonte18">Abaixo se apresenta a relação das Forças Restritivas (obstáculos) em ordem decrescente de freqüência, conforme suas respostas à primeira parte deste instrumento.</p>
                        ...
                        <p class="fonte18">Lembre que quem vai gerenciar o CAMPO DE FORÇAS entre as Forças Propulsoras e as Forças Restritivas é a <b>Força Propulsora 17.</b></p>
                        <p class="fonte18"><b>A Força Propulsora 17</b> monitora em tempo real como você está conduzindo o processo de vendas.</p>
                        <p class="fonte18"><b>A Força Propulsora 17</b> nos indica as Forças Propulsoras que devem ser usadas, tanto na etapa de <b>Exposição</b> do produto como na etapa da <b>Negociação</b>, para neutralizar os obstáculos.</p>
                        <p class="fonte18">Especificamente fazemos referência ao Instrumento 5 – Meu Conhecimento da Linha de produtos que vendo e ao Instrumento 6 – Meu Conhecimento dos produtos concorrentes.</p>
                        ...
                        <p class="fonte18">Um musico profissional de musica erudita treina 10 horas por dia, para que sua apresentação seja perfeita.</p>
