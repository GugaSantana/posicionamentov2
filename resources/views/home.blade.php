        ...
        <div class="row">
            <div class="col-xl-12 order-xl-1">
                    <div class="card-header bg-white border-0">
                        <h3 class="mb-0"><center>INSTRUMENTO 1</center></h3>
                        <h3 class="mb-0"><center>MEU NÍVEL DE EMPREENDEDORISMO</center></h3>
                    </div>

                    <div class="card-body bg-white">
                        <div class="col-12">
                            <p style="align: center"><b>Levantamento de Informações</b></p>
                            <p>Todas as pessoas têm combinações de VISÃO e de AÇÃO em tudo o que fazem e, naturalmente, esta combinação varia de pessoa para pessoa.</p>
                            ...
                            <p>A Ação é fundamental para implementar a Visão, para levar a Visão à pratica.</p>
                            ...
                            <p><b style="color: #35408f">EFICÁCIA</b> (fazer as coisas certas) = <b style="color: #35408f">VISÃO</b>      e sua</p>
                            <p><b style="color: #35408f">EFICIÊNCIA</b> (fazer as coisas da maneira certa) = <b style="color: #35408f">AÇÃO</b>.</p>
                        </div>
                        <br>
                        <div class="col-12">
                            <p><b>INSTRUÇÕES</b></p>
                            <p>Este instrumento está constituído de duas partes.</p>
                            <p>Na primeira parte são apresentadas 10 questões que você deve responder escolhendo a alternativa que mais se ajusta a você, ou seja, aquela que melhor representa seu comportamento.</p>
                            <p>Na segunda parte você deverá posicionar seu resultado em uma escala</p>
                        ...
                        <p>Responda qual é a sua tendência, seu comportamento em relação às questões abaixo colocadas e registre o resultado num ponto da escala, levando em conta as definições da escala:</p>
