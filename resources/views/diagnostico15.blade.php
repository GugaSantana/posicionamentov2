...
<div class="card card-primary">
    ...
    <div class="card-body">
                    ...
                    <br>
                    <p class="fonte18">É obvio que quanto mais argumentos tivermos para vender nossos produtos, mais eficazes seremos para implementar as etapas de APRESENTAÇÃO e NEGOCIAÇÃO das Vendas Consultivas. Em consequência disso, poderemos fechar Vendas com maior Produtividade e em menor tempo.</p>
                    <p class="fonte18">Os Argumentos de Vendas são fundamentais para neutralizar obstáculos e para induzir a decisão do cliente à compra de nossos produtos.</p>
                    <p class="fonte18">Quanto maior número de argumentos de qualidade tivermos, mais fácil será alcançar nossas Metas de Vendas.</p>
                    <p class="fonte18">A maioria dos vendedores dispõe de poucos Argumentos de Vendas, muitas vezes de pouco valor de convencimento. Isto compromete os resultados.</p>
                    <p class="fonte18">Imagine a seguinte situação real, uma constante em nossa experiência com esta Metodologia:</p>
                    ...
                    <br>
                        ...
                        <p class="fonte18">A seguir, são apresentadas novamente para sua leitura atenta, as definições das 17 Forças Propulsoras:</p>

                        <p class="fonte18"><b>F1- Benefício</b> - Informa aos clientes o que podem lucrar, ou como podem melhorar sua situação, adquirindo o produto/serviço oferecido. Explicita o valor da proposta e induz à percepção desse valor por parte do cliente.</p>
                        ...
                        <p class="fonte18"><b>F6- Prestígio</b> - Informa ao cliente sobre o conceito do produto o qual estamos oferecendo e o conceito sobre a empresa, como são vistos no mercado. Esclarece sobre a boa qualidade e benefícios proporcionados por seus produtos ou serviços. Apoia-se em evidências de realidade. É comprovável, são dados objetivos de mercado e não apenas argumentos do vendedor. São evidências.</p>
                        ...
                        <p class="fonte18"><b>F8- Explicação</b> - Permite esclarecer o cliente em relação àquelas informações que não lhe são familiares, principalmente em termos de conteúdos técnicos. Transmite segurança ao cliente.</p>
                        ...
                        <p class="fonte18"><b>F10- Prestígio Pessoal</b> - Eleva o conceito do vendedor junto ao seu cliente, mostrando que ele está apto a solucionar problemas e auxiliá-lo, quando necessário. É fundamental quando se trata de Vendas Consultivas. Sem Prestigio Pessoal não se transmite confiança ao cliente.</p>
                        ...
                        <p class="fonte18">Observe o forte desbalanceamento dos argumentos, quando eles são remetidos às Forças Propulsoras nas quais se classificam.</p>
                        ...
                        <p class="fonte18">É possível aumentar significativamente a quantidade de argumentos desde que se implemente as Recomendações que serão apresentadas na próxima seção</p>
                        ...
                        <p class="fonte18">O resultado final será o aumento do número de vendas, você irá aumentar sua receita e alcançar suas Metas com maior facilidade.</p>
                        ...
                        <p class="fonte18">Lembramos a você que a Força Propulsora 17 monitora o uso de todas as outras Forças Propulsoras.</p>
                        <p class="fonte18">Esta é a força que gerencia o sistema, para que você utilize cada Força Propulsora correta, no momento certo!</p>
                        <p class="fonte18">Imagine a Força Propulsora 17 como sendo uma câmera que filma como você está conduzindo o Processo de Venda e indicando em tempo real, como se fosse um mecanismo de Feedback: que Força Propulsora você deve aplicar neste momento.</p>
                        <p class="fonte18">Vejamos no exemplo seguinte como você deveria agir mentalmente:</p>
                        <p class="fonte18">“Agora devo utilizar mais F8, necessito aumentar o número de argumentos relativos a F3 e F4 (sobre os concorrentes), para equilibrar melhor a relação com os F1 e F2. Agora é o momento de utilizar F7 porque o cliente não está prestando muita atenção ou o F6 para mostrar que temos evidências reais e comprovadas dos benefícios do produto que estou vendendo”.</p>
