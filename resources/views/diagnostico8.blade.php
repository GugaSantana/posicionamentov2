...
<div class="card card-primary">
    ...
    <div class="card-body">
                    <div class="col-12">
                        ...
                        <p class="fonte18">Esta Metodologia apresenta uma das mais poderosas técnicas para criar esta condição, apoiada em dois fatores fundamentais para garantir um relacionamento motivador e produtivo entre o vendedor e o cliente: o FEEDBACK e a EXPOSIÇÃO.</p>
                        <p class="fonte18">Cruzando estas duas variáveis, geram-se 4 quadrantes que devem ser administrados pelo vendedor para <b>“gerenciar”</b> o Campo Psicológico com o cliente e viabilizar as Vendas de maneira mais produtiva.</p>
                        ...
                        <p class="fonte18">Você respondeu um questionário que é a base para seu Diagnóstico e para as Recomendações, com o objetivo para que você possa gerenciar os processos de <b>EXPOSIÇÃO</b> e de <b>FEEDBACK</b>, para melhorar de maneira técnica, o relacionamento com seus clientes.</p>
                        ...
                        <p class="fonte18"><b>Quadrante 1:</b> O EU ABERTO, representa as facetas da personalidade conhecidas pela própria pessoa e que está disposta a abrir aos outros. Nesta área tanto a pessoa como os outros têm a percepção e acesso a seus conteúdos, os seja, os outros veem a pessoa exatamente como ela se vê.</p>
                        ...
                        <p class="fonte18">São os aspectos que a pessoa não consegue perceber em si mesma, embora sejam percebidos pelos outros. Por exemplo, uma pessoa pode não admitir que é ansiosa, porém os outros a veem como tal.</p>
                        ...
                        <p class="fonte18"><b>Quadrante 4:</b> O EU DESCONHECIDO, compreende os aspectos da personalidade que nem ela nem os outros conhecem ou percebem. Incluem-se no Eu Desconhecido certos sentimentos ou impulsos reprimidos ou inconscientes, talentos ou habilidades inexploradas, etc.</p>
                        ...
                        <p class="fonte18">Observe o perfil de sua janela no gráfico apresentado no seu Diagnóstico. Você poderá concluir facilmente com qual dos quatro perfis acima apresentados mais se assemelha o seu Diagnóstico.</p>
                        ...
                        <p class="fonte18">- Uma janela a mais ampla possível, que mostra sua capacidade de relacionamento positivo e empatia com seus clientes.</p>
                        ...
                        <p class="fonte18">Para movimentar o eixo do Feedback nos momentos oportunos, peça ao seu cliente que manifeste como se sente em relação ao comportamento que você apresenta e o quanto ele o afeta. Isto é, você deve solicitar Feedback e o Feedback aumentará a área no sentido horizontal.</p>
                        ...
                        <p class="fonte18">Mais uma vez lembramos que o objetivo da venda consultiva se alcança com mais facilidade se a área da JANELA alcança o nível 80/80 da escala e os processos de Exposição e Feedback estão equilibrados em seus valores na escala.</p>
