...
<div class="card card-primary">
    ...
    <div class="card-body">
                    ...
                    <div class="col-12">
                        ...
                        <p class="fonte18">Em cada questão apresentada, você terá que distribuir cinco pontos entre as duas opções.</p>
                    ...
                    <div class="col-12">
                        ...
                        <form name="formulario" role="form" method="post" action="instrumento/8">
                            ...
                            <p class="fonte18">Como você, sendo um vendedor, trataria estas situações se elas acontecessem com um cliente?</p>
...
<br><b>OU</b>
<br>B. Confessaria minha ignorância. Fosse qual fosse a reação do cliente, eu encorajaria a continuação da conversa.
','
5. Se eu estivesse sob forte e crescente pressão pessoal e um de meus clientes me dissesse que eu estava me tornando impaciente com ele e também lhe prestando cada vez menos bons serviços, eu:
...
<br>A. Procuraria usar mais autocrítica e tentaria avaliar meus pontos fracos como vendedor, para fazer um trabalho melhor no futuro.
<br><b>OU</b>
<br>B. Arriscaria o embaraço de discutir meus pontos fracos com os clientes, obtendo deles ideias sobre como eu poderia melhorar.
','
...
','
13. Se ao conversar com um novo cliente que poderia representar uma conta valiosa para mim, ele desse igual consideração a um produto de um concorrente, tão bom quanto o meu em cada detalhe, eu:
...
<br>A. Faria tudo para convencê-los das qualidades do produto e do quanto eles o necessitariam, usando minha abordagem mais sincera e persuasiva para fechar a venda, quando eles se tornassem receptivos.
<br><b>OU</b>
...
<br>A. Tentaria contornar a questão ou contar uma história lógica para explicar minha chamada, sem mencionar o outro vendedor, receando que ressentimentos entre terceiros pudessem provocar a perda de uma venda que, de outra maneira, seria conseguida facilmente.
<br><b>OU</b>
...
<br>A. Pediria a ele para dizer honestamente se eu estaria desperdiçando o seu tempo e o meu próprio, continuando a procurá-lo.
<br><b>OU</b>
...
<br>A. Procuraria dar toda a importância à autoavaliação que o cliente fez de suas necessidades, fechando a venda, como consequência.
<br><b>OU</b>
...
<br><b>OU</b>
<br>B. Admitiria a veracidade de suas alegações e se possível, lhe diria o que eu estaria fazendo para contornar o problema.
','
...
<br>A. O confrontaria diretamente, perguntando-lhe qual seria o problema e por que ele estaria tentando prejudicar-me aos olhos dos outros.
<br><b>OU</b>
