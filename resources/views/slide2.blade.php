...
<body style="background-image: linear-gradient(to right, #1794d0, #000652);background-repeat: no-repeat;
  ...
  <div class="container">
    <div class="row" style="height: 100vh;">
      <div class="col-md-6" style="align-self: center;color: white;text-align: end;font-size: 40px;font-weight: bold;">
        SOMOS<br>CONSULTORES EM<br>COMPETITIVIDADE<br>SISTÊMICA
      </div>
      <div class="col-md-6" style="align-self: center;color: white;text-align: start;font-size: 18px; padding-right: 12%;">
