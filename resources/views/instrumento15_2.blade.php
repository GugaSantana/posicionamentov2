...
<div class="card card-primary">
    <div class="card-header" style="min-height: 8em;">
        ...
        <h3>
            <center>AVALIAÇÃO DA QUANTIDADE E QUALIDADE DOS MEUS<br>ARGUMENTOS DE VENDAS (FORÇAS PROPULSORAS)</center>
        </h3>
        </div>
    ...
    <div class="card-body">
                    ...
                    <div class="col-12">
                        <h4>
                            ...
                            <p class="fonte18">Nesta etapa você está recebendo os argumentos que você formulou, assim como as Definições das 17 Forças Propulsoras das Vendas.</p>
                    </div>
                    ...
                    <div class="col-12">
                        ...
                        <p class="fonte18">Lembre-se que você só pode alocar cada argumento a uma única Força Propulsora.</p>
