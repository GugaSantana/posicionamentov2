...
@section('site.content')
    ...
    <div class="barra-dourada-divisao"> <h2>PRÓXIMOS PASSOS</h2></div>
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="center-content">
                    ...
                    <p>SE VOCÊ QUER SABER SOBRE O INVESTIMENTO PARA ADQUIRIR O <b style="color: #ffde66;">PROGRAMA TOP SELLER</b>, POR FAVOR ENTRE EM CONTATO CONOSCO CLICANDO <a style="color: white; text-decoration: underline !important;" href="/contato">AQUI.</a></p>
                  </div>
                  <div class="center-content">
                    <!-- <h2>ESTRUTURA DA METODOLOGIA</h2><br> -->
                    <p>SE VOCÊ QUER EFETUAR O PAGAMENTO DO SEU INVESTIMENTO NO <b style="color: #ffde66;">PROGRAMA TOP SELLER</b> POR FAVOR INSIRA ABAIXO O NÚMERO DO SEU VOUCHER:</p>
                    <form class="form-inline" method="post" action="/payment/checkout">
                      {!! csrf_field() !!}
