...
<form action="/examples/actions/confirmation.php" method="post">
	...
	<div class="form-group">
		<a href="/manualIntro" type="submit" class="btn btn-primary btn-lg btn-block">Login</a>
	</div>
	<p><a href="#">Esqueceu sua senha?</a></p>
</form>
<p class="text-center small">Não tem uma conta? <a href="#">Crie aqui!</a></p>
</div>
</body>
</html>                            