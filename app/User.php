...
class User extends Authenticatable
{
     ...
     */
    protected $fillable = [
        'name', 'gender', 'email', 'password', 'cpf', 'nascimento', 'schooling', 'course', 'fone', 'cellphone', 'cep', 'address', 'quarter', 'city', 'state', 'number', 'complement', 'company_id', 'branch', 'activity', 'office', 'role_id' ];
